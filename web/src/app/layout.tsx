...
export const metadata: Metadata = {
  ...
  description: 'Cuéntanos lo esencial de tu negocio para crear una estrategia, contenido y campañas con mayor claridad.',
  applicationName: 'Crisdal Agency',
  robots: { index: false, follow: false },
  openGraph: {
    title: 'Radiografía de Marca | Crisdal Agency',
    description: 'Ordenemos lo esencial de tu marca antes de diseñar, grabar o pautar.',
    type: 'website',
    locale: 'es_PE',
  },
};
